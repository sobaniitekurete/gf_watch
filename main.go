...
//		DeepEqual_(im[30][w-30], []uint8{49, 49, 49, 255}) {
...
//					if DeepEqual_(im[30][w-30], []uint8{49, 49, 49, 255}) {
//						return -1, -1
//					}
//					return x, y
//				}
...
//	} else if DeepEqual_(im[10][w-10], []uint8{255, 178, 0, 255}) && DeepEqual_(im[30][w-30], []uint8{49, 49, 49, 255}) {
//		return false
//	}
//	for x := (h / 2); x < h; x++ {
//		for y := 0; y < (w / 2); y++ {
